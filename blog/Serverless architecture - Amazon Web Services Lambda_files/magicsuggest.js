...
(function($)
{
    ...
    var TagSuggest = function(element, options)
    {
        ...
        var defaults = {
            ...
            /**
             * @cfg {String} returnType
             * <p>Format to return. Only 'string' value is valid</p>
             * Defaults to <code>id</code>.
             */
            returnType: '',
        ...
        var handlers = {
            ...
            _onKeyUp: function(e) {
                ...
                switch(e.keyCode) {
                    ...
                    if(e.keyCode !== 188 || cfg.useCommaKey === true ||  cfg.useSpaceKey === true) {
                        e.preventDefault();
                        console.log('fdff')
